...
class AppResponse(Enum):
    ...
    DISABLE_ACCOUNT = status.HTTP_200_OK, 'ACCOUNT__DISABLE__SUCCESS'
    ENABLE_ACCOUNT = status.HTTP_200_OK, 'ACCOUNT__ENABLE__SUCCESS'
    ...
    UPDATE_DOCUMENTS_FAILURE = status.HTTP_400_BAD_REQUEST, "DOCUMENTS__UPDATE__FAILURE"
    ...
    CREATE_MEETING_SCHEDULE = status.HTTP_201_CREATED, "MEETING_SCHEDULE__CREATE__SUCCESS"
    UPDATE_MEETING_SCHEDULE = status.HTTP_200_OK, "MEETING_SCHEDULE__UPDATE__SUCCESS"
